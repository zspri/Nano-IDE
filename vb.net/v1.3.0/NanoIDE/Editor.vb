...
Public Class Editor
    ...
    Public Function HandleKeyEvent(e As KeyEventArgs)
        If e.KeyCode = Keys.A And My.Computer.Keyboard.CtrlKeyDown Then ' Select All
            TextArea.SelectAll()
            e.Handled = True
        ElseIf e.KeyCode = Keys.F And My.Computer.Keyboard.CtrlKeyDown Then ' Full Screen
    ...
    Private Sub ContextMenuLabel_Click(sender As Object, e As EventArgs) Handles ContextMenuLabel.Click, MenuIcon.Click
        ContextMenu1.Show()
    ...
    Private Sub OpenFileLabel_Click(sender As Object, e As EventArgs) Handles OpenFileLabel.Click, OpenFileIcon.Click
        If Not ((OpenFileDialog.FileName = "") And (TextArea.Text = "")) Then
            DialogBoxResult = MsgBox("Save changes to current file?", MsgBoxStyle.YesNoCancel)
            ' Yes = 6
            ' No = 7
    ...
    Private Sub SaveFileLabel_Click(sender As Object, e As EventArgs) Handles SaveFileLabel.Click, SaveFileIcon.Click
        SaveFileDialog.InitialDirectory = OpenFileDialog.FileName
        SaveFileDialog.ShowDialog()
    End Sub

    Private Sub NewFileLabel_Click(sender As Object, e As EventArgs) Handles NewFileLabel.Click, NewFileIcon.Click
        Me.Cursor = Cursors.WaitCursor
        If Not ((OpenFileDialog.FileName = "") And (TextArea.Text = "")) Then
            DialogBoxResult = MsgBox("Save changes to current file?", MsgBoxStyle.YesNoCancel)
            ' Yes = 6
